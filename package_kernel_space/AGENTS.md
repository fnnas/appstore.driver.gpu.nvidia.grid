...
- 例如 `6.18.18.c788-trim` 使用 `6.18.18.c788-trim-<arch>`，`6.18.18.c877-trim` 使用 `6.18.18.c877-trim-<arch>`，`6.18.18.c938-trim` 使用 `6.18.18.c938-trim-<arch>`，`6.18.18.c952-trim` 使用 `6.18.18.c952-trim-<arch>`，`6.18.18.c1032-trim` 使用 `6.18.18.c1032-trim-<arch>`，`6.18.18.c1078-trim` 使用 `6.18.18.c1078-trim-<arch>`。
