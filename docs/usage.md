...
如果系统是 `6.18.18.c1032-trim #1032`，应选择 `6.18.18.c1032-trim-amd64` 包：
...
#### 额外的占位空包
在 fnos 1.2.0700 开始(低于该版本无需安装)  
系统及应用相关功能会检查是否安装了`Nvidia-Driver-580`

建议在安装驱动或更新到该版本之前，安装本仓库提供的空包`Nvidia-Driver-580.tgz.fpk`，否则相关功能可能无法使用

运行环境管理的设置未进行兼容，反正我们也用不到

![21_package_fake_offical_580.png](usage/21_package_fake_offical_580.png)
