...
- 当前已构建内核包：`6.18.18-trim`、`6.18.18.c788-trim`、`6.18.18.c877-trim`、`6.18.18.c938-trim`、`6.18.18.c952-trim`、`6.18.18.c1032-trim`、`6.18.18.c1078-trim`
- 当前构建架构：`amd64`
- 应用中心 `platform`：`x86`
...
- `6.18.18.c1032-trim-amd64`
- `6.18.18.c1078-trim-amd64`
